...
# ╔═╡ a6b6da82-08df-4728-86bc-3a65222db1fc
using OrdinaryDiffEq, Plots, PlutoUI; plotly()

# ╔═╡ 00becdb0-1414-11ee-12af-fd8d6f18e703
md"# Pluto Notebook for Tutorial 09x08"

# ╔═╡ a1b5514b-fc0d-4570-8d5c-7e532fc4116e
md"## Load Packages"

# ╔═╡ 74d73bef-fb76-4f6f-bcc5-eeebd44c6e81


# ╔═╡ c7600e6d-2949-48f6-8f1e-20ef6a9e720b


# ╔═╡ 26eb0349-4ba9-47b5-9c16-49db623df31b


# ╔═╡ 6316cace-3e42-462c-9080-6281374598cd


# ╔═╡ fd34e334-3ec0-4695-9faa-7f337ebd1e15
md"## Describe Problem"

# ╔═╡ a482c316-8d7f-4717-bfb4-00100b09aabb
md"#### Lotka-Volterra Equations"

# ╔═╡ fbcd93ec-09c2-483a-8caa-21b26b8ac021
md"$\begin{align}
\frac{dx}{dt} &= \alpha x - \beta xy \\
\frac{dy}{dt} &= \delta xy - \gamma y
\end{align}$"

# ╔═╡ db1570c0-3e64-46e3-b165-008fe8219304
md"where $x$ is the number of prey (e.g., rabbits),"

# ╔═╡ b97e9eda-7739-4b0b-98a0-0b121b02ac06
md"and $y$ is the number of some predator (e.g., foxes),"

# ╔═╡ 56f10fe5-0b37-46a3-98d2-be4530490d9a
md"and $\frac{dx}{dt}$ and $\frac{dy}{dt}$ represent the instantaneous growth rates of the two populations,"

# ╔═╡ 51d5f3af-9a8f-4a09-a3b9-5ddc06d02df3
md"and $t$ represents time,"

# ╔═╡ 365f7458-a027-4ddd-958d-a8185605edcd
md"and $\alpha, \beta, \delta, \gamma$ are positive real parameters describing the interaction of the two species."

# ╔═╡ 722b206c-f056-42e8-948f-2d26ff939a62
md" $\alpha$ is the prey population growth rate and $\beta$ is the prey population decline rate."

# ╔═╡ 4a7072a0-0595-473d-bf89-01252ce3dc1c
md" $\delta$ is the predator population growth rate and $\gamma$ is the predator population decline rate."

# ╔═╡ 1f12afee-ea5a-4573-8cc1-1a5f5d8b72ef
md"---"

# ╔═╡ e0a0ef94-7528-4e20-9d3f-5699a4ca4835


# ╔═╡ 329666ef-700c-4917-8c8a-0e49bb214f20
md"#### OrdinaryDiffEq.jl"

# ╔═╡ aed27e03-932e-40d1-ad58-fbd9d5a4117c
md"$f(du, u, p, t) =
\begin{cases}
...
# ╔═╡ 8c926d1d-36e0-4cb0-b829-4a74abe35d26
md"## Define Julia Function"

# ╔═╡ 0f2fbbbc-3395-40c3-9844-8acfd1d431ae
...
# ╔═╡ 0771cde1-3b8b-48d0-bdc1-5d6f871cf027
md"---"

# ╔═╡ 38aaaf5b-ae84-4bae-b224-3ad7b34d9684


# ╔═╡ 09565a47-63d6-48fa-8783-0abc32467d0a


# ╔═╡ 836ef132-957b-4cb8-94fb-1c1cb305634a


# ╔═╡ 0d47785d-7040-4dac-84b1-1babec1d92de
md"## Assign Variables"

# ╔═╡ a49bb23a-13e8-41db-a839-9b4c79cc98ab
md"### u: Populations"

# ╔═╡ 2b3593ce-984f-4ba0-a2c1-c81b5385b97c
md"#### x: Populations of Rabbits"

# ╔═╡ 099db1ea-fba0-41c6-8090-a45c408942ff
md"#### y: Population of Foxes"

# ╔═╡ 32bc1e27-a25f-4342-88a7-19c052b158c4


# ╔═╡ 9dd3a334-3e8a-4410-a3c9-b93407ac0695


# ╔═╡ 5d2645b8-2f75-408c-91ae-75a487536c29


# ╔═╡ f8d3b29e-39e2-47a8-b67b-2d3a393cddae


# ╔═╡ f832a88c-65a8-41ea-8ff6-4e08c35cd5d4


# ╔═╡ f34e51ee-07c8-4ee6-bf4b-fd8f00c122d1


# ╔═╡ a1662418-0b1a-4e62-8f33-bf69c6518177


# ╔═╡ 101e4b5b-831c-448f-933c-da7be8b21fcc
md"### p: Parameters"

# ╔═╡ f05038ab-e29f-413c-9ad8-d7e56694b412
md"#### alpha: Rabbit Population Growth Rate"

# ╔═╡ dc29f999-9925-4de2-874b-46df69626943
md"#### beta: Rabbit Decline Rate"

# ╔═╡ d3057c82-60fb-4d08-8e75-d55591f89681
md"#### delta: Fox Population Growth Rate"

# ╔═╡ 87a6ed8f-796f-40d4-9ad6-058907164757
md"#### gamma: Fox Population Decline Rate"

# ╔═╡ c4dd4b51-2cbb-401c-bbe0-7fc43ff06203


# ╔═╡ 8f839a55-abd1-42c2-b5b3-ed95fa4f10d3


# ╔═╡ a86209cc-f4a8-4a6c-a32c-3eaec1a4ebb1


# ╔═╡ 50878a4f-b529-4560-87c6-1d38c1ce6c3c


# ╔═╡ cc9b3d1c-5236-49c7-b18a-b940249d7020


# ╔═╡ f35cf483-5be1-49eb-96ae-5ac6313d6395


# ╔═╡ 4f11ad76-07b3-4cc7-9d1d-53906a10af1c
md"### t: Time"

# ╔═╡ 26e19b52-46df-4684-9bde-57eb9950aaa4
t_begin = 0

# ╔═╡ de84e0b0-a9a2-4cc1-b1c7-2798bd731e10
md"---"

# ╔═╡ 18e44bb5-0bc6-4204-989b-00090b74097b


# ╔═╡ d02dc779-e7e5-4ce4-9d2f-ae2eed3b4004


# ╔═╡ a456c3fc-5bba-4c21-9e35-a18f75e4b18b


# ╔═╡ f9bad91d-d5ff-4cef-ab66-ae4a4dfb1b7b


# ╔═╡ 1aeadb7e-f247-4a63-b880-2da7acd9d2e9


# ╔═╡ 39da97b6-a752-4ba4-a84b-828bcae4e026


# ╔═╡ cfaf4e9f-79df-4118-8fc8-77f3f5113a75


# ╔═╡ b3e5835e-20b3-45ee-ad4b-790a85bb0fa0


# ╔═╡ 030783d5-df8a-4557-bde9-c1eb6692f277


# ╔═╡ 2e341613-fdf6-4209-b0b0-abe6a9db1fdc
md"## Define System of First Order ODEs Problem"

# ╔═╡ 60fc0df7-5a4b-426f-8ea8-5a5fe0f8c746
md"---"

# ╔═╡ 009df122-f4c7-4d5d-a331-ca1fc675c728


# ╔═╡ 3e3e3667-1916-4868-8171-e2868928f0e8


# ╔═╡ 1b053df4-4104-4e29-8c63-cfc3a77ea82e


# ╔═╡ 7b6a72c3-8206-4836-b393-60580f690519


# ╔═╡ 621867dc-10b3-4e6d-a1fe-a44880ca37ee


# ╔═╡ 473a82f9-16fa-4907-81d2-dff29b3d47b4


# ╔═╡ 661b7870-e6b3-478f-9efe-4add2bf40db8


# ╔═╡ 23299eea-d72e-4fef-baf3-4d98d29c9949


# ╔═╡ c484e960-dd44-4ede-82f6-dbca8962e40b
md"## Solve Problem"

# ╔═╡ 5f82e96c-f8b4-468f-85a1-d8736856cf0d
md"---"

# ╔═╡ cd6f3b97-a432-4d5b-978f-abb62de2c278


# ╔═╡ 9fa67e0a-f90c-4607-a43d-c4f3535fce0c
md"## Interactive Model"

# ╔═╡ b01d08c9-cea1-4c81-a845-4da8fc7356cc
@bind reset Button("Reset")

# ╔═╡ 46ccec93-1396-4e73-83a8-ced5876a0fa1
begin
	reset
	md"Time (t): $(@bind t_end Slider(0.0:0.1:10.0, 10.0, true))"
end

# ╔═╡ 81081874-a54e-4778-a7d6-c0d2ada5d175
tspan = (t_begin, t_end)

# ╔═╡ b8da46f7-e887-43ac-b7aa-6e6bd52b55e2
begin
	reset
	md"""
...
# ╔═╡ 0f02869e-b872-4d1e-bd49-5f32473e9140
u_begin = [x_begin, y_begin]

# ╔═╡ 38578b76-23f9-4121-a902-ad618466325a
begin
	reset
	md"""
	Rabbit Growth:
...
# ╔═╡ be285d17-d532-4e83-aa94-7d0afabb5d18
p = [alpha, beta, delta, gamma]

# ╔═╡ b44ac7d8-edd4-417b-98b3-86a4d69b2709
prob = ODEProblem(lotka_volterra, u_begin, tspan, p)

# ╔═╡ 8d8f2ec0-c131-4a70-b854-2f21f5ee0b16
sol = solve(prob, Tsit5())

# ╔═╡ 55898063-4b31-4d18-b77e-4636a6b3537d
rabbit = sol(t_end)[1]

# ╔═╡ f21c8565-1264-419c-9be7-659b6dd6f2dc
fox = sol(t_end)[2]

# ╔═╡ a2f98306-0a41-4431-9c5f-4cdb1a9e93c6
md"""
...
# ╔═╡ 1a0ebe76-4abb-437e-a5ff-3baa6ed9207b
plot(sol,
	legend = (0.78, 0.9),
	linewidth = 2,
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "b54530e60f481204fd540c6645ebf81c1c899e1a"

...
# ╔═╡ b207ae88-1d45-48ce-ac14-8c7619849308
begin
	using Catalyst
end

# ╔═╡ 23742d6a-5733-4a80-8455-5f75fa01a463
begin
	nMax = 5
	@parameters k[1:12]
	@variables t
...
# ╔═╡ 4a943cb0-c2f1-4508-aaef-0210b8229de6
begin
	reactions = []
...
# ╔═╡ ca50d942-e5e4-4873-aac1-cd5523df479a
begin
	# Cis aggregation/splitting
...
# ╔═╡ 65a97273-c276-4dbc-b9ef-b2333fc0d49e
begin
	# Maturation
	for i=2:nMax
...
# ╔═╡ e925c5ef-85b5-4042-bb7b-cd5d9e9fb3c5
@named system = ReactionSystem(reactions, t, [collect(C); collect(M); collect(T)], k, combinatoric_ratelaws=true)

# ╔═╡ 36040911-291b-4152-ad93-586c905e20f3
complexgraph(system)

# ╔═╡ 9da8bba1-2833-4814-a46e-b158e19ba0ae
savegraph(complexgraph(system),"testgrph.png")
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "b324743f254548923d2d45ee089cd2a334797373"

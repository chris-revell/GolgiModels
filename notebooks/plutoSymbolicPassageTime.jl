...
# ╔═╡ 714b653a-0081-11ee-08ab-533388752c5d
begin
	using Symbolics
	using LinearAlgebra
	using SparseArrays
...
# ╔═╡ 60db304e-7a42-445b-8426-aad93dcf62b9
md"# Model"
...
# ╔═╡ 7726bb92-17cb-43f7-9c23-315db6574efd
@variables k₁ k̂₂ k̂₃ k₄ k₅ k̂₆ k̂₇ k₈ k₉ k̂₁₀ k̂₁₁ k₁₂

# ╔═╡ 027e842d-e08f-4b96-8178-ad5c3fcfe92a
md"# 3x3 Version"

# ╔═╡ 8a651738-4ee9-4c3d-b2ce-efba770eeb4a
begin
	K₃ = sparse(Diagonal([-k₁, -k̂₂-k₄, -k̂₃]))
	K₃[2,1] = k₁
	K₃[2,3] = k̂₃
	K₃[3,2] = k̂₂
	latexify(Matrix(K₃))
...
# ╔═╡ dcf62b72-befc-48e0-aaea-d1ed42551b17
K₃⁻¹ = simplify.(inv(Matrix(K₃)))

# ╔═╡ 90bcead8-ecc2-4b84-9478-9df3667a366c
τ₃ = (sum(K₃⁻¹[:,1]))

# ╔═╡ ee541492-d4a0-472e-9ca7-312a64db4706
md"# 5x5 Version"

# ╔═╡ d76b87ed-f2ca-4e87-9ee0-b03e44a067fd
begin
	K₅ = sparse(Diagonal([-k₁, -k̂₂-k₄, -k̂₃, -k₅-k̂₆-k₈, -k̂₇]))
	K₅[2,1] = k₁
	K₅[2,3] = k̂₃
	K₅[2,4] = k₅
	K₅[3,2] = k̂₂
...
# ╔═╡ c897d3e0-6948-42f5-bdeb-1e6ae3976913
K₅⁻¹ = simplify.(inv(Matrix(K₅)))

# ╔═╡ 55766103-1d41-4a7b-b316-ee6670cb688c
τ₅ = (sum(K₅⁻¹[:,1]))

# ╔═╡ 99789d73-195d-44bd-8eeb-26e6f64d2dd3
md"# 7x7 Version"
...
# ╔═╡ 9dcaf463-ced0-4b04-ac00-b1795221fb3d
...
# ╔═╡ 4ca8bac9-a658-4d6f-9af6-9a5b0de9b24d
latexify(rn; form=:ode)

# ╔═╡ 4076f80f-fcdb-4150-bd2a-cabea2cb7d27
grph = complexgraph(rn)

# ╔═╡ 946e7877-f487-4d42-b48b-97247fd5cfe2
savegraph(grph,"grph.png")

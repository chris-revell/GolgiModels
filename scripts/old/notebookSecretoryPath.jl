...
# ╔═╡ cc184763-bb7b-4aca-85bc-0da76b81500c
nPoints = 7;

# ╔═╡ a1185404-50c6-4b81-a0ad-1e6d9fcc43f9
fig = Figure(); ax = Axis(fig[1,1]);

# ╔═╡ 53365894-bddc-46ed-8e62-1f70fb4f9d2f
positions = [Point2f0(0.0,0.0),Point2f0(0.0,0.5),Point2f0(0.0,1.0),Point2f0(0.5,0.5),Point2f0(0.5,1.0),Point2f0(0.0,1.5),Point2f0(0.5,1.5)];

# ╔═╡ 56955005-ebf5-4b82-9c4e-72cc394c32b0
markerSizes = 20.0.*ones(nPoints);

# ╔═╡ 4348b679-5106-4c4a-b651-1d84a035773f
labels = [
	"ER",
	"Golgi",
	"Secretory vesicle",
...
# ╔═╡ 3193d800-b618-49c1-a9d2-3233ddeb5aa0
lines = [
...
# ╔═╡ 03d174b2-32be-4bfe-bda5-7e85fca6bd4a
for l in lines
	lines!(ax,l;color=:black)
end

# ╔═╡ 68dd54d1-dfdb-4462-a9f5-670ea6027a41
scatter!(ax,positions;markersize=markerSizes);

# ╔═╡ 2196c7ed-c065-4e78-b1d8-cd4813c24bfa
text!(
    fill("Makie", 7),
    position = [Point2f(0, i/2) for i in 1:7],
...
# ╔═╡ 55345933-8773-43dc-a9f4-ac805f3f9841
xlims!(ax,(-0.1,0.6))

# ╔═╡ d8c059e2-7bd0-4574-a1ee-000d4b4575f9
ylims!(ax,(-0.1,1.6))

# ╔═╡ 4332fbae-11e6-414e-b2a5-4bf949aed95c
hidedecorations!(ax)

# ╔═╡ 323e2771-5f24-49e1-81be-df8f22bd9ea7


# ╔═╡ 77d0b910-b59b-4fcd-97e2-2c50c5d8d7ca
fig
